				...
				{					
					...
					else
					{
						switch(System.Dsp.Mode)
						{
							...
							case VIEW_MODE : PhotoMvUp() ;  break ;
			...
			case 6 :
				{
					if(*System.Key.Keylong)
					{
						switch(System.Dsp.Mode)
						{
							...
							case CHECK_MODE :  PccamMode();	break ;
					...
					else
					{
						...
						switch(System.Dsp.Mode)
						{
							case PCCAM_MODE :  break ;
							case CHECK_MODE : 													 										
							case VIEW_MODE  : PhotoMvLeft() ;  break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: break ;
							default :break ;
						}						
			...
			case 7 :
				{
					if(*System.Key.Keylong)
					{
					   ...
					   switch(System.Dsp.Mode)
						{
							case PCCAM_MODE :  break ;
							case CHECK_MODE :  ViewMode();	break ;
							case VIEW_MODE :   CheckMode();break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: break ;
							default :break ;
					...
					else
					{
						switch(System.Dsp.Mode)
						{
							case PCCAM_MODE :  break ;
							case CHECK_MODE : 													 										
							case VIEW_MODE  :  PhotoMvDown() ; break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: break ;
							default :break ;
						}						
			...
			case 8 :
				{
					...
					if(*System.Key.Keylong) 
					{
						...
						{
							case PCCAM_MODE :  break ;
							case CHECK_MODE : TfMode();		break ;
							case VIEW_MODE :   break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: CheckMode();	break ;
							default :break ;
						}	
					}
					else
					{	
						switch(System.Dsp.Mode)
						{
							case PCCAM_MODE :  break ;
							case CHECK_MODE : 													 										
							case VIEW_MODE  :  PhotoMvRight() ; break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: break ;
							default :break ;
						}					
			...
			case 9 :
				{
					if(*System.Key.Keylong) 
					{
						...
						{
							case PCCAM_MODE :  
							case CHECK_MODE :  break ;												 										
							case VIEW_MODE  : PhotoDelAll();  break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: break ;
							default :break ;
						}	
					...
					else
					{
						...
						{
							case PCCAM_MODE :  
							case CHECK_MODE : 	PhotographOne(); break ;												 										
							case VIEW_MODE  : PhotoDelOne();  break ;
							case SLEEP_MODE :  break ;
							case TF_MODE 	: break ;
							default :break ;
						}	
