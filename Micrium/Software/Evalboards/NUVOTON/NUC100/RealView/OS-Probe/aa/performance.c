...
void SHOW_SCREEN_WC_NUM(uint8_t comm,wchar_t *p,uint16_t NUM,wchar_t *s,uint16_t NUM1)
{
    uint8_t i=0,t = 0 ; ; 
	 ...
	 else
	 {
		 ...
		 char_array[t+2*i-5] = NUM1/100 +0x30 ;   
...
void XyZoomFucAgu(uint8_t Zoom, uint8_t X,uint8_t Y)
{
	if((System.Dsp.Mode == CHECK_MODE)||
	   (System.Dsp.Mode == PCCAM_MODE))
	{
   		Dsp_Send_Data(0x2C,Zoom,X,Y,D_NON); 
	}	
}
...
{		   //00  --µÚ¶þÏóÏÞ
		   ...
		   //03	 --µÚËÄÏóÏÞ
			...
			if((System.VyZoom[1] <0x80)&&(System.VyZoom[2] <0x80))			 
			{
			//	Dsp_Send_Data(0x33,System.VyZoom[0] ,0x00,System.VyZoom[1],System.VyZoom[2]);	  // ×ó±ßÒÆ¶¯
				Dsp_Send_Data(0x33,System.VyZoom[0] ,0x00,0x80 - System.VyZoom[1],0x80 - System.VyZoom[2]);
			}
			else if((System.VyZoom[1] <0x80)&&(System.VyZoom[2] >0x80))
			{
				Dsp_Send_Data(0x33,System.VyZoom[0] ,0x02,0x80-System.VyZoom[1],System.VyZoom[2]-0x80);
			}
			else 
			if((System.VyZoom[1] >0x80)&&(System.VyZoom[2] <0x80))
			{
				Dsp_Send_Data(0x33,System.VyZoom[0] ,0x01,System.VyZoom[1]-0x80,0x80-System.VyZoom[2]);
			}
			else if((System.VyZoom[1] >0x80)&&(System.VyZoom[2] >0x80))
			{
				Dsp_Send_Data(0x33,System.VyZoom[0] ,0x03,System.VyZoom[1]-0x80,System.VyZoom[2]-0x80);
			}
...
void PhotoMvUp()
{
	...
	//	PriorExposure();
		...
		if(System.Dsp.CheckMode.Zoom != X0)
		{
            if(System.XyZoom[2] >10){System.XyZoom[2] -=10; }	
            XyZoomFucAgu(System.XyZoom[0],System.XyZoom[1],System.XyZoom[2] );
		}
	}
	else if((System.Dsp.Mode == VIEW_MODE)&&(System.Dsp.ViewMode.Zoom != X0 ))
	{
//		Select_Send(0x17);
		if(System.Dsp.ViewMode.Zoom != X0)
		{
            if(System.VyZoom[2] >0x20) { System.VyZoom[2] -=0x20; }	
			ViewMove(); 	
		}	
		OSTimeDly(10);	
	}
...
void PhotoMvDown()
{
	...
	//	Select_Send(0x18);
		...
		if(System.Dsp.ViewMode.Zoom != X0)
		{
            if(System.VyZoom[2] <0xC0) { System.VyZoom[2] +=0x20; }	
			ViewMove(); 	
		}
	...
	else  	if((System.Dsp.Mode == CHECK_MODE)||(System.Dsp.Mode == PCCAM_MODE))
	{
		if(System.Dsp.CheckMode.Zoom != X0)
		{
	        //·Å´ó,ÉÏÒÆ
	        if(System.XyZoom[2] <160){System.XyZoom[2] +=10; }	
	        XyZoomFucAgu(System.XyZoom[0],System.XyZoom[1],System.XyZoom[2] );
		}		
	}
}
...
void PhotoMvLeft()
{
	...
	if((System.Dsp.Mode == VIEW_MODE))
	{
		...
		//	Select_Send(0x19);
		 	if(System.Dsp.ViewMode.Zoom != X0)
			{
	            if(System.VyZoom[1] >0x20) { System.VyZoom[1] -=0x20; }	
				ViewMove(); 	
			}
			OSTimeDly(10);	
		}
	...
	else if((System.Dsp.Mode == CHECK_MODE)||(System.Dsp.Mode == PCCAM_MODE) )
	{
		...
		{
            //·Å´ó,zuoÒÆ
            if(System.XyZoom[1] >10){System.XyZoom[1] -=10; }	
            XyZoomFucAgu(System.XyZoom[0],System.XyZoom[1],System.XyZoom[2] );
		}
...
void PhotoMvRight()
{
	if((System.Dsp.Mode == VIEW_MODE))
	{
		if(System.Dsp.ViewMode.Zoom != X0)
		{
			...
			if(System.Dsp.ViewMode.Zoom != X0)
			{
	            if(System.VyZoom[1] <0xC0) { System.VyZoom[1] +=0x20; }	
				ViewMove(); 	
			}
			OSTimeDly(10);		
		}
	...
	else if((System.Dsp.Mode == CHECK_MODE)||(System.Dsp.Mode == PCCAM_MODE) )
	{
		...
		{
            //·Å´ó,zuoÒÆ
            if(System.XyZoom[1] <240){System.XyZoom[1] +=10; }	
            XyZoomFucAgu(System.XyZoom[0],System.XyZoom[1],System.XyZoom[2] );
		}
...
void PhotoNext()
{
	...
	{
		Select_Send(0x2b);
//		Dsp_Send_Data(0x2B,0x60,0x01,0x42,0x43);
		OSTimeDly(20);	
	}
}
		...
		switch(NUM)
		{
			...
			case X0 :	Select_Send(0x30);  
						System.Dsp.CheckMode.Zoom = X0 ;
							System.XyZoom[0] = 0x25;
							System.XyZoom[1] = 113;
							System.XyZoom[2] = 88;
						Dsp_Send_Data(0x2C,0x25,System.XyZoom[1],System.XyZoom[2],D_NON); 

						OSTimeDly(10);break ;  //DSP_SENDB(0xe2,NULL," "); 
			
			case X1 : //	Scen_Send(0x2C,0x30);  	
						Dsp_Send_Data(0x2C,0x48,System.XyZoom[1],System.XyZoom[2],D_NON); 	
						System.Dsp.CheckMode.Zoom = X1 ;
						System.XyZoom[0] = 0x48;
						OSTimeDly(10); break ;//DSP_SENDB(0xe2,NULL,"X3"); 		
						 
			case X2 : //	Scen_Send(0x2C,0x50);  	
					    Dsp_Send_Data(0x2C,0x60,System.XyZoom[1],System.XyZoom[2],D_NON); 
						System.Dsp.CheckMode.Zoom = X2 ;	
						System.XyZoom[0] = 0x60;
						OSTimeDly(10);break ; //DSP_SENDB(0xe2,NULL,"X5"); 	
						
 			case X3 :  // Scen_Send(0x2C,0x70);  
						Dsp_Send_Data(0x2C,0x70,System.XyZoom[1],System.XyZoom[2],D_NON); 			
 		 				System.Dsp.CheckMode.Zoom = X3 ;	
						System.XyZoom[0] = 0x70;
	...
	else if(System.Dsp.Mode == VIEW_MODE)
	{
		switch(NUM)
		{
			case X0 :	Select_Send(0x3A); 
						...
						System.VyZoom[0] = 0x10;
						System.VyZoom[1] = 0x80;
						System.VyZoom[2] = 0x80;
...
void PhotographOne()
{
	if(System.Dsp.Mode == CHECK_MODE)
	{
		...
		OSTimeDly(5);
	//	Select_Send(0x21); 					
		Dsp_Send_Data(0x21,0x02,0x01,0x01,D_NON);
...
void PhotoDelAll(void) //(uint8_t KeyValue) 
{
	...
	if(System.Dsp.Mode == VIEW_MODE)
	{
		SHOW_SCREEN_T_W(0xE3,0x05,WcharToChar(L"Delete All Images?"));	//SHOW_SCREENW(0xE8, WcharToChar(L"Ç©·¢Êý¾Ý²É¼¯,ÇëÉÔºò...") );	
		//SHOW_SCREEN_T_W(0xE3,0x5, "Del all Images?");	
	...
	//	SHOW_SCREENW(0xE8, WcharToChar(L"É¾³ýËùÓÐÕÕÆ¬?") );
		...
		{		
			...
			if(key)
			{
				if(KeyValue == key)
				{
					SHOW_SCREEN_T_W(0xE3,0x05,WcharToChar(L"deleting, please wait..."));		
				 // 	SHOW_SCREENW(0xE8, WcharToChar(L"É¾³ýÖÐ...") );
				//	 SHOW_SCREEN_T_W(0xE3,0x05, "deleting, please wait...");
